    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none z-0 hidden md:block">
          ...
          <div className="absolute top-[20%] right-[20%] p-3 rounded-2xl bg-red-500/15 backdrop-blur-sm border border-white/5 animate-float animation-delay-300 shadow-xl shadow-red-500/5">
          ...
          <div className="absolute bottom-[30%] left-[25%] p-3 rounded-2xl bg-gradient-to-r from-cyan-500/15 to-pink-500/15 backdrop-blur-sm border border-white/5 animate-float animation-delay-600 shadow-xl shadow-cyan-500/5">
          ...
          <div className="absolute top-[65%] right-[25%] p-3 rounded-2xl bg-blue-500/15 backdrop-blur-sm border border-white/5 animate-float animation-delay-1000 shadow-xl shadow-blue-500/5">
          ...
          <div className="absolute bottom-[35%] right-[15%] p-3 rounded-2xl bg-green-500/15 backdrop-blur-sm border border-white/5 animate-float animation-delay-700 shadow-xl shadow-green-500/5">
        ...
        <div className="container relative mx-auto px-4 text-center z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold mb-4 md:mb-6 drop-shadow-2xl">
              <span className="text-white" style={{ textShadow: '0 2px 10px rgba(0,0,0,0.8), 0 4px 20px rgba(0,0,0,0.5)' }}>Boost Your Online</span>
              <br />
              <span className="text-white" style={{ textShadow: '0 2px 10px rgba(0,0,0,0.8), 0 4px 20px rgba(0,0,0,0.5)' }}>Presence with </span>
              <span className="bg-gradient-to-r from-green-400 via-green-500 to-green-600 bg-clip-text text-transparent" style={{ textShadow: '0 2px 10px rgba(0,0,0,0.8)' }}>
                inflnce.io
              </span>
            </h1>
            
            <p className="text-lg sm:text-xl text-gray-400 mb-6 md:mb-8 max-w-2xl mx-auto px-4 sm:px-0" style={{ textShadow: '0 1px 8px rgba(0,0,0,0.9), 0 2px 15px rgba(0,0,0,0.6)' }}>
              Your one-stop platform for social media growth, publications, and digital marketing tools.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
              <Button size="lg" className="green-gradient-bg h-12 sm:h-14 px-6 sm:px-8 text-base sm:text-lg shadow-xl" style={{ boxShadow: '0 4px 15px rgba(0,0,0,0.6)' }} asChild>
                <Link href="/sign-up">
                  Get Started
      ...
      <section className="py-12 sm:py-16 bg-gray-950">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 sm:mb-12">
            <span className="inline-block px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-medium text-green-400 border border-green-400/30 bg-green-400/10 mb-4 sm:mb-6">
              Our Services
            </span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 text-white">Comprehensive Services</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            <Card className="bg-gray-900/50 border-gray-800 hover:border-green-500/50 transition-all sm:col-span-2 md:col-span-1">
              <CardHeader className="text-center pb-4 px-6">
                ...
                <CardTitle className="text-xl sm:text-2xl text-white mb-2">Social Media Growth</CardTitle>
              ...
              <CardContent className="space-y-3 px-6">
                ...
                <Link href="/services/social-media" className="inline-flex items-center gap-2 text-green-400 hover:text-green-300 font-medium mt-6 py-2 text-sm sm:text-base">
            ...
            <Card className="bg-gray-900/50 border-gray-800 hover:border-green-500/50 transition-all">
              <CardHeader className="text-center pb-4 px-6">
                ...
                <CardTitle className="text-xl sm:text-2xl text-white mb-2">Publication Features</CardTitle>
                <CardDescription className="text-gray-400 text-sm sm:text-base">
            ...
            <Card className="bg-gray-900/50 border-gray-800 hover:border-green-500/50 transition-all sm:col-span-2 md:col-span-1">
              <CardHeader className="text-center pb-4 px-6">
                ...
                <CardTitle className="text-xl sm:text-2xl text-white mb-2">Digital Marketing Tools</CardTitle>
                <CardDescription className="text-gray-400 text-sm sm:text-base">
      ...
      <section className="py-12 sm:py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 text-white">Why Choose inflnce</h2>
            <p className="text-gray-400 text-base sm:text-lg max-w-3xl mx-auto px-4 sm:px-0">
      ...
      {/* CTA Section */}
      <section className="py-12 sm:py-16 bg-gray-950 border-t border-gray-800">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto mb-8 sm:mb-12 px-4 sm:px-0">
