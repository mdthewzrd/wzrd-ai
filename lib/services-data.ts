...
export const servicesData: Service[] = [
  // Instagram Services
  {
    ...
    notes: "Campaign begins within 24 hours. Typical results based on previous campaigns:",
    icon: "instagram",
  ...
  },
  {
    ...
    notes: "Single post engagement. Starts within 24h. Typical results:",
    icon: "instagram",
    gradient: "instagram-gradient",
    packages: [
      {
  ...
  // YouTube Services
  {
    ...
    description: "Complete engagement packages for YouTube videos. Typical results based on previous campaigns:",
    icon: "youtube",
  ...
  // Spotify Services
  {
    ...
    notes: "Campaign includes organic promotion strategies. Typical results based on previous campaigns:",
    icon: "spotify",
  ...
  // Publications
  {
    ...
    notes: "Professional media placement services. Results vary by publication and campaign strategy:",
    packages: [
      {
