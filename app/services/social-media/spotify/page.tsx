...
export default async function SpotifyServicesPage() {
  ...
  const platformButtons = [
    ...
    { name: "Spotify", href: "/services/social-media/spotify", className: "bg-green-500 text-white", active: true },
  ];
        ...
        <div className="container relative mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-6 mb-8">
              <div className="h-20 w-20 rounded-2xl bg-green-500 flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-xl text-muted-foreground">
                  Boost your Spotify tracks with plays, followers, and playlist placements
                </p>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle className="text-base">How quickly will my Spotify campaign start?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  All Spotify campaigns start within 24 hours of order placement. You&apos;ll receive a confirmation email once your campaign begins.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
                <CardTitle className="text-base">Are the plays and followers real?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-base">Is this safe for my Spotify account?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Absolutely. We use gradual delivery methods that comply with Spotify&apos;s daily limits. Our services have a 99.9% safety record.
                </p>
              </CardContent>
            </Card>
          </div>
