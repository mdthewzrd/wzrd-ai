...
export default async function InstagramServicesPage() {
  ...
  const platformButtons = [
    { name: "Instagram", href: "/services/social-media/instagram", className: "bg-gradient-to-r from-purple-500 to-pink-500 text-white", active: true },
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container relative mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-6 mb-8">
              <div className="h-20 w-20 rounded-2xl bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center">
                <div className="text-white font-bold text-2xl">IG</div>
              </div>
              <div>
                ...
                <p className="text-xl text-muted-foreground">
                  Premium growth and engagement solutions for Instagram
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-pink-500/30 p-4 rounded-lg text-center">
                <Check className="h-6 w-6 text-pink-400 mx-auto mb-2" />
      ...
      <InstagramServiceSelector services={instagramServices} />
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle className="text-base">How quickly will my campaign start?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  All Instagram campaigns start within 24 hours of order placement. You&apos;ll receive a confirmation email once your campaign begins.
                </p>
              </CardContent>
            </Card>
            <Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-base">Is this safe for my account?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
