...
export default function TikTokServiceSelector({ services }: Props) {
              ...
              <Card 
                ...
                className={`cursor-pointer transition-all ${
                  selectedService.id === service.id 
                    ? "border-cyan-400 bg-gradient-to-r from-cyan-400/10 to-pink-500/10" 
        ...
        <div className="lg:col-span-2">
          <div className="mb-8">
            ...
            {selectedService.notes && (
              <div className="mt-4 p-4 bg-gradient-to-r from-cyan-400/10 to-pink-500/10 border border-cyan-400/20 rounded-lg">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {selectedService.packages.map((pkg) => (
              <Card 
                key={pkg.name} 
                className={`relative ${pkg.highlight ? "border-cyan-400 shadow-lg shadow-cyan-400/25" : "border-gray-700/50 hover:border-cyan-400/50 transition-colors"}`}
              >
                {pkg.highlight && (
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                    <Badge className="bg-gradient-to-r from-cyan-400 to-pink-500 text-white">
                ...
                <CardContent>
                  ...
                  <Button className="w-full mt-6 bg-gradient-to-r from-cyan-400 to-pink-500 hover:from-cyan-500 hover:to-pink-600 text-white">
                    Select {pkg.name}
